...
class Ppgutc(object):
    ...
    def __init__(self, args):
        ...
        self.actionlist = (
            ...
            (29, "r", "2,2", "pairs of guillemets (across lines)", r'«([^»]+|[\n])+»'),
            (30, "r", "2,2",
            ...
            (74, "r", "2,2", "double punctuation",
             r'(,\.)|(\.,)|(,,)|([^\.]\.\.[^\.])'),
            (75, "m", "0,0", "Unexpected/ususual paragraph end", "check_paraend"),
    ...
    def saveFile(self, buffer, fn):
        ...
        f1.write("PP Workbench report generated by ppgutc (version {})\r\n".format(self.VERSION))
